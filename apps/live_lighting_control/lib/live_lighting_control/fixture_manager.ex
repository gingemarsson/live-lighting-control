  ...
  def init(_args) do
    ...
    fixture_types = [
      ...
      %FixtureType{
        ...
        channels: [
          %FixtureTypeChannel{id: UUID.uuid4(), attribute: "red", dmx_address: 0, type: :color_red},
          %FixtureTypeChannel{id: UUID.uuid4(), attribute: "green", dmx_address: 1, type: :color_green},
          %FixtureTypeChannel{id: UUID.uuid4(), attribute: "blue", dmx_address: 2, type: :color_blue},
          %FixtureTypeChannel{id: UUID.uuid4(), attribute: "white", dmx_address: 3, type: :color_white},
          %FixtureTypeChannel{id: UUID.uuid4(), attribute: "amber", dmx_address: 4, type: :color_amber},
          %FixtureTypeChannel{id: UUID.uuid4(), attribute: "uv", dmx_address: 5, type: :color_uv},
          %FixtureTypeChannel{id: UUID.uuid4(), attribute: "dimmer", dmx_address: 6, type: :dimmer},
          %FixtureTypeChannel{id: UUID.uuid4(), attribute: "strobe", dmx_address: 7, type: :strobe}
        ]
      }
    ]
